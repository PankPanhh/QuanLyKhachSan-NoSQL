...
function MainPage() {
    ...
    const fetchRooms = async () => {
      try {
        ...
        if (Array.isArray(rooms)) {
          setFeaturedRooms(rooms.slice(0, 5)); // Chỉ lấy 3 phòng đầu
        } else {
  ...
  return (
    <>
          ...
          >
            <div className="row align-items-center m-auto pt-5 px-4 px-lg-0">
              <div className="text-start col-md-6 col-lg-5 col-xl-6 offset-lg-1">
                <h2 className="display-1 fw-normal">
                  Serpentine Palace - Where elegance coils in mystery
                </h2>
      ...
      <section id="info">{/* ... (Nội dung Info) ... */}</section>
