...
import { 
  FaTachometerAlt, FaHotel, FaBook, FaUsers, 
  FaQuestionCircle 
} from 'react-icons/fa';
  ...
  return (
    <div style={styles.sidebarContainer}>
      ...
      <div style={styles.helpSection}>
        <FaQuestionCircle style={styles.helpIcon} />
        <h5 style={{color: 'white', margin: '0.5rem 0'}}>Need help?</h5>
        <p style={{color: '#a0aec0', fontSize: '0.9rem', marginBottom: '1rem'}}>Please check our docs</p>
        <button style={styles.upgradeButton}>DOCUMENTATION</button>
        <button style={{...styles.upgradeButton, marginTop: '0.5rem', background: '#0f1734', border: '1px solid #3b82f6'}}>UPGRADE TO PRO</button>
      </div>
    </div>
  );
}
